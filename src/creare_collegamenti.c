...
database CreaCollegamentoBranoGenere( Brano NuovoBrano , database Database ) {
  ...
  int IdGenere = 0;
   ...
   if ( strcmp( scelta , "1" ) == 0 ) {
	   ...
	   Database = AssociaBranoGenere( Database , NuovoBrano.idBrano , IdGenere );
...
database CreaCollegamentoPlaylistBrano( Brano NuovoBrano , database Database ) {
   ...
   int IdPlaylist = 0;
       ...
       if ( strcmp( scelta , "1" ) == 0 ) {
		   ...
		   Database = AssociaPlaylistBrano( Database , NuovoBrano.idBrano , IdPlaylist );
...
database CreaAssociazioneBranoArtista( Brano NuovoBrano , database Database ) {
   ...
   int IdArtista = 0;
       ...
       if ( strcmp( scelta , "1" ) == 0 ) {
               ...
               Database = AssociaBranoArtista( Database , NuovoBrano.idBrano , IdArtista );
...
database CreareCollegamentiGenereBrani( database Database , Genere NuovoGenere ) {
    ...
    int IdBrano = 0;
        ...
        if ( strcmp( scelta , "1" ) == 0 ) {
                ...
                Database = AssociaBranoGenere( Database , IdBrano , NuovoGenere.idGenere );
...
database CreareCollegamentiPlaylistBrani( database Database ,  Playlist NuovaPlaylist ) {
    ...
    do {
        ...
        if ( strcmp( scelta , "1" ) == 0 ) {
                ...
                Database = AssociaPlaylistBrano( Database , IdBrano , NuovaPlaylist.idPlaylist );
...
database CreareCollegamentiArtistaBrani( database Database , Artista NuovoArtista ) {
    ...
    do {
        ...
        if ( strcmp( scelta , "1" ) == 0 ) {
                ...
                Database = AssociaBranoArtista( Database , IdBrano , NuovoArtista.idArtista );
